        ...
        <div>
            <div class="flex justify-end sm:justify-between px-[20px] mb-3">
                ...
                <div>
                    ...
                    <button id="modalButton" data-modal-target="categoryModal" data-modal-toggle="categoryModal"
                            ...
                            <tr class="pt-4">
                                ...
                                <td>
                                    <div class="flex gap-5 items-center justify-center">
                                        ...
                                        {{-- <a href="updateCategory/{{ $data->id }}"
                                            class=" updateBtn cursor-pointer w-[42px]"> --}}
                                        <button class="updateBtn" categoryId="{{ $data->id }}">
                                            <svg class="h-[40px] w-[40px]" width="40" height="40"
                                        ...
                                        {{-- <button data-modal-target="Updatecategorymodal"
                                            ...
                                            class=" updateBtn cursor-pointer w-[42px]  "
                                            updateId="{{ $data->id }}"><svg class="h-[40px] w-[40px]" width="40"
...
<script>
    $(document).ready(function() {
            ...
            $('.updateBtn').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#text').html("@lang('lang.Update')");
                        $('#modalHeading').html("@lang('lang.Update_Category')");


                        $('#categoryModal').removeClass('hidden').addClass('flex');
                        $('#categoryForm').attr("url", "updateCategory/" + id);
        ...
        function closeModal() {
            ...
            $('#categoryForm').attr("url", "../addCategory");
            $('#modalHeading').html("@lang('lang.Add_Category')");
