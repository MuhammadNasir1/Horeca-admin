...
<div id="categoryModal" data-modal-backdrop="static"
    ...
    <div class="relative p-4 w-full   max-w-4xl max-h-full ">
        ...
        @if (isset($categoryData))
            <form id="categoryForm" method="post" url="../updateCategory/{{ $categoryData->id }}">
            @else
        ...
        <div class="relative bg-white shadow-dark rounded-lg  dark:bg-gray-700  ">
            <div class="flex items-center   justify-start  p-5  rounded-t dark:border-gray-600 bg-primary">
                <h3 class="text-xl font-semibold text-white ">
                    @lang(isset($categoryData) ? 'lang.Update_Category' : 'lang.Add_Category')
                </h3>
                <button type="button"
                    class=" absolute right-2 text-white bg-transparent rounded-lg text-sm w-8 h-8 ms-auto "
            ...
            <div class="grid lg:grid-cols-2 gap-x-6 gap-y-4 mx-6 my-6">
                ...
                <div class="">
                    ...
                    <select class="w-full border-[#DEE2E6] rounded-[4px] focus:border-primary   h-[40px] text-[14px]"
                        ...
                        <option
                            {{ isset($categoryData->status) && $categoryData->status == 'active' ? 'selected' : '' }}
                            value="active">@lang('lang.Active')</option>
                        <option
                            {{ isset($categoryData->status) && $categoryData->status == 'not-active' ? 'selected' : '' }}
                            value="not-active">@lang('lang.Not_Active')</option>
                    </select>
