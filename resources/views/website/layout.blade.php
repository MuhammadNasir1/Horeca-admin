    ...
    <footer class="bg-white rounded-lg  dark:bg-gray-900 m-4">
        <div class="w-full  mx-auto p-4 md:py-8">
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a
                    href="https://horeca-kaya.com/" class="hover:underline">Horeca</a> @lang('lang.All_Rights_Reserved')
                @lang('lang.Developed_by') <a href="https://thewebconcept.com/" target="_blank"
                    class="text-primary font-semibold">The Web Concept</a></span>
        </div>
    </footer>
