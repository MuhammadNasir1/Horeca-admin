                                ...
                                <td>
                                    <div class="flex gap-5 items-center justify-center">
                                        ...
                                        <a href="../updateBrands/{{ $data->id }}">
                                            <button class="  cursor-pointer w-[42px] "><svg class="h-[40px] w-[40px]"
...
<div id="brandModal" data-modal-backdrop="static"
    ...
    <div class="relative p-4 w-full   max-w-4xl max-h-full ">
        @if (isset($brandData))
            <form id="brandForm" method="post" url="../updateBrandData/{{ $brandData->id }}">
            @else
        ...
        <div class="relative bg-white shadow-dark rounde d-lg  dark:bg-gray-700  ">
            <div class="flex items-center   justify-start  p-5  rounded-t dark:border-gray-600 bg-primary">
                <h3 class="text-xl font-semibold text-white ">
                    @lang(!isset($brandData) ? 'lang.Add_Brand' : 'lang.Update_Brand')
                </h3>
                <button type="button"
                    class=" absolute right-2 text-white bg-transparent rounded-lg text-sm w-8 h-8 ms-auto "
            ...
            <div class="flex justify-end ">
                <button class="bg-primary text-white py-2 px-6 my-4 rounded-[4px]  mx-6 uaddBtn  font-semibold "
                    ...
                    <div id="text">
                        @lang(!isset($brandData) ? 'lang.Save' : 'lang.Update')
                    </div>
